...
namespace OnBoardy.API.Migrations
{
    ...
    [Migration("20260328142344_AddOrganizationModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnBoardy.API.Models.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_modules_organization_id");
            ...
            modelBuilder.Entity("OnBoardy.API.Models.Module", b =>
                {
                    ...
                    b.HasOne("OnBoardy.API.Models.Organization", "Organization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_modules_organizations_organization_id");
